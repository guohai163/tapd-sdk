...
def compute_update_size(workspace_id, stories, tapd=None):
    """
            ...
            while True:
                ...
                for iteration in iterations['data']:
                    print('{}\t{}\t{}\t{}'.format(iteration['Iteration']['id'], iteration['Iteration']['name'],
                                                  iteration['Iteration']['startdate'], iteration['Iteration']['status']))
                ...
                while True:
                    ...
                    if input_select_id == '1':
                        compute_update_size(input_workspace_id, storie['data'], tapd)
                    if input_select_id == '3':
